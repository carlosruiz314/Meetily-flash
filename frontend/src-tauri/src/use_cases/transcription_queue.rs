...
/// Two-phase processing: transcription, then (optionally) summary.
/// Diarization is not a queue phase; it runs via run_diarization_for_meeting
/// (commands.rs) after Enhance/import/retranscribe.
